...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContent.size'
        db.add_column('page_page_textcontent', 'size',
                      self.gf('django.db.models.fields.CharField')(default='medium', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContent.size'
        db.delete_column('page_page_textcontent', 'size')
