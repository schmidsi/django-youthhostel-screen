...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewswallContent'
        db.create_table('page_page_newswallcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newswallcontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('page', ['NewswallContent'])

        # Adding M2M table for field sources on 'NewswallContent'
        db.create_table('page_page_newswallcontent_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newswallcontent', models.ForeignKey(orm['page.newswallcontent'], null=False)),
            ('source', models.ForeignKey(orm['newswall.source'], null=False))
        ))
        db.create_unique('page_page_newswallcontent_sources', ['newswallcontent_id', 'source_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewswallContent'
        db.delete_table('page_page_newswallcontent')

        # Removing M2M table for field sources on 'NewswallContent'
        db.delete_table('page_page_newswallcontent_sources')
