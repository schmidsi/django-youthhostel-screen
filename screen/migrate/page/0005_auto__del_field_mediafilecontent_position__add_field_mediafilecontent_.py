...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('page_page_mediafilecontent', 'type',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=20),
                      keep_default=False)


        # Changing field 'MediaFileContent.mediafile'
        db.alter_column('page_page_mediafilecontent', 'mediafile_id', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(to=orm['medialibrary.MediaFile']))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('page_page_mediafilecontent', 'type')


        # Changing field 'MediaFileContent.mediafile'
        db.alter_column('page_page_mediafilecontent', 'mediafile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medialibrary.MediaFile']))
