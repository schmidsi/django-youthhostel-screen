...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.navigation_extension'
        db.delete_column('page_page', 'navigation_extension')


    def backwards(self, orm):
        # Adding field 'Page.navigation_extension'
        db.add_column('page_page', 'navigation_extension',
