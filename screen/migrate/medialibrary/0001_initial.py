...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medialibrary_category', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', to=orm['medialibrary.Category'], blank=True, null=True)),
        ...
        db.create_table('medialibrary_mediafile', (
            ...
            ('file_size', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True)),
        ))
